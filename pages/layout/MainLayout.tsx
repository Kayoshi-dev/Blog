...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    <>
      <header className="container mx-auto px-8 max-w-6xl">
        <nav className="px-2">
          <div className="container flex flex-wrap items-center justify-between mx-auto">
            <a href="#" className="flex items-center">
              <span className="self-center font-bold text-xl whitespace-nowrap dark:text-white">
                Kayoshi's lab
              </span>
            </a>
            <button
              ...
              <ul className="flex flex-col items-center p-4 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                ...
                <li>
                  <button
                    ...
                    onClick={() => toggleTheme()}
                  >
                    <SunIcon className="h-5 w-5 hidden dark:flex text-white" />
      ...
      <main
        className={`container mx-auto px-8 max-w-6xl md:mt-48 ${outfit.className}`}
      >
        {children}
      </main>
    </>
